...
docker run --rm --network host -e WHITE_CANE_PORT=$WHITE_CANE_PORT -p $WHITE_CANE_PORT:$WHITE_CANE_PORT -v $(pwd):$WHITE_CANE_ROOT $WHITE_CANE_IMAGE:$WHITE_CANE_IMAGE_TAG
